...
__host__ __device__ T cast_dtype(const S value) {
  return T(value);
}

template <>
__host__ __device__ fp16 cast_dtype(const float value) {
  return __float2half(value);
}

template <>
__host__ __device__ bf16 cast_dtype(const float value) {
  return __float2bfloat16(value);
}

template <>
__host__ __device__ float cast_dtype(const fp16 value) {
  return __half2float(value);
}

template <>
__host__ __device__ float cast_dtype(const bf16 value) {
